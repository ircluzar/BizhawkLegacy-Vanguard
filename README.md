...
## Bizhawk Legacy (RTCV Backport)

THIS IS BASED ON AN OLD VERSION OF BIZKAWK.
IT CONTAINS BUGS THAT HAS ALREADY BEEN FIXED.

The sole purpose of this implementation is for N64 Dynarec (Better auto-corrupt)
